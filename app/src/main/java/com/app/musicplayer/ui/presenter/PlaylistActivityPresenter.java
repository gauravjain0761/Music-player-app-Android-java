...
public class PlaylistActivityPresenter extends BasePresenter<IActivityContract.IActivityView> implements IActivityContract.IActivityPresenter, ICallback {

    private static final String TAG = PlaylistActivityPresenter.class.getSimpleName();
    ...
    public PlaylistActivityPresenter(Context context, IActivityContract.IActivityView view) {
        super(context, view);
