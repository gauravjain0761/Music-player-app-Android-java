...
public class PlaylistSongsActivityPresenter extends BasePresenter<IActivityPlaylistSongsContract.IActivityPlaylistSongsView> implements IActivityPlaylistSongsContract.IActivityPlaylistSongsPresenter, ICallback {

    private static final String TAG = PlaylistSongsActivityPresenter.class.getSimpleName();
    ...
    public PlaylistSongsActivityPresenter(Context context, IActivityPlaylistSongsContract.IActivityPlaylistSongsView view) {
        super(context, view);
        this.context = context;
    }

    public void setBinding(ActivityPlaylistSongsBinding bind) {
        this.binding = bind;
    }
