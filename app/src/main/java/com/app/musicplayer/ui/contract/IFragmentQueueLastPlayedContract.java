...
public interface IFragmentQueueLastPlayedContract {
    interface IFragmentQueueLastPlayedPresenter extends IBasePresenter<IFragmentQueueLastPlayedView> {
    ...
    interface IFragmentQueueLastPlayedView extends IBasePresenterView<IFragmentQueueLastPlayedPresenter> {
