...
public interface IActivityScanFilesContract {
    interface IActivityScanFilesPresenter extends IBasePresenter<IActivityScanFilesView> {
    ...
    interface IActivityScanFilesView extends IBasePresenterView<IActivityScanFilesPresenter> {
