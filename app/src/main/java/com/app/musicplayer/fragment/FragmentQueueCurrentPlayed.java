...
public class FragmentQueueCurrentPlayed extends Fragment {
    String TAG = FragmentQueueCurrentPlayed.class.getSimpleName();
    private static FragmentQueueCurrentPlayedBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentQueueCurrentPlayedBinding.inflate(inflater, container, false);
